...
async def setup_settings():
    ...
    with ui.column().classes("w-full q-pa-lg"):
        ...
        with ui.card().classes("full-width q-mb-lg"):
            ...
            with ui.row().classes("w-full gap-md"):
                ...
                with ui.card().classes("col text-center"):
                    ui.label(
                        current_video_dir.split("/")[-1] if current_video_dir else "Not set"
                    ).classes("text-h6")
        ...
        with ui.card().classes("full-width q-mb-lg"):
            ...
            def update_species_visibility():
                ...
                if mode == "bundled":
                    inputs["species_csv"].visible = False
                else:
                    inputs["species_csv"].visible = True
        ...
        with ui.card().classes("full-width q-mb-lg"):
            ...
            def update_behaviors_visibility():
                ...
                if mode == "none":
                    inputs["behaviors_csv"].visible = False
                else:
                    inputs["behaviors_csv"].visible = True
            ...
            inputs["behaviors_csv"].visible = behaviors_mode != "none"
                    ...
                    with ui.card().classes("q-pa-lg"):
                        ...
                        with ui.row().classes("w-full justify-end gap-md"):
                            ...
                            ui.button(
                                "Reset",
                                color="negative",
                                on_click=lambda: _do_reset(reset_dialog),
                            )
    ...
    async def _do_reset(dialog):
        ...
        ui.notify("Database reset! Restarting sync...", type="positive")
    ...
    async def apply_settings():
        ...
        if species_mode == "bundled":
            ...
            new_config["species_csv_path"] = inputs["species_csv"].value.strip()
        ...
        if behaviors_mode == "none":
            ...
            new_config["behaviors_csv_path"] = inputs["behaviors_csv"].value.strip()
